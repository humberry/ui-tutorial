...
class AreYouEnabledView(ui.View):
    ...
    def button_pressed(self, sender):
        ...
        if sender.name == "alert":
            self.console_alert(user_text)
        elif sender.name == "hud_alert":
            self.console_hud_alert(user_text)
        elif sender.name == "popover":
            self.popover(user_text)
        elif sender.name == "print":
            print(user_text)
        elif sender.name == "say":
            speech.say(user_text)
